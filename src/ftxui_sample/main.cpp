...
// configuration step. It creates a namespace called `fun_with_images`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", fun_with_images::cmake::project_name, fun_with_images::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", fun_with_images::cmake::project_version);
      return EXIT_SUCCESS;
    }
